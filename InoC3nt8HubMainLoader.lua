...
local Config = {
    ...
    ServiceId       = 27034, -- Your PlatoBoost Service ID
    PlatoSecret     = "1a6e8fa4-549d-4956-90f0-6c558619807e", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/InoC3nt8Hub/InoC3nt8HubMain/refs/heads/main/InoC3nt8HubMainLoader.lua", -- The raw URL of your main script
    
    -- [4] Social Media Settings (Set to true to show, false to hide)
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/Eph4pnayP",
    ...
    -- [5] File System
    KeyFileName     = "MyInoc3nt8key.txt", -- The name of the file where the valid key will be saved for auto-login
    ...
    HubName         = "InoC3nt8Hub Key", -- The main title shown at the top of the GUI
    HubDescription  = "Key System No Bypassed" -- The text shown below the title
}
